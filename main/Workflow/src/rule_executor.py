...
class RuleExecutor:
    ...
    def match_rule(self, od: ODAPI, lhs: UUID, *, pivot: dict[Any, Any], params: dict[str, Any] = {}):
        lhs_matcher = match_od(
            ...
            eval_context=self.eval_context | params,
            pivot=pivot,
        )
        return lhs_matcher

    def rewrite_rule(self, od: ODAPI, rhs: UUID, *, pivot: dict[Any, Any], params: dict[str, Any] = {}):
        rhs = rewrite(
            self.state,
            rhs_m=rhs,
            pattern_mm=self.mm_ramified,
    ...
    def load_match(self, file: str | Path) -> Any:
